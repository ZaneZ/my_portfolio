...
function DataHandler(mongoUrl){
    this.mongoUrl = mongoUrl || 'mongodb://localhost:27017/resumes';
...
/**
* Search data from profile
* @arg {object} - the condition in profile collections
* @return {promise} - How to deal with the profile on success or failure with error.
*/
